...
void main() {
	...
	test("verifySignature works", () {
		var fakeSelfSigned = PrivatePeerIdentity(clientPrivKey,
			PeerIdentity.signed("client", clientPubKey, clientPrivKey.createSigner(SIGNING_ALG)));
	...
	test("json converters", () {
		...
		assert(
			key2.firstPrimeFactor == serverPrivKey.firstPrimeFactor &&
		...
		var sign = serverPrivKey.createSigner(SIGNING_ALG)
			.sign(data);

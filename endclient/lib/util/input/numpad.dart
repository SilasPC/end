...
class _NumpadState extends State<Numpad> {
  ...
  Widget buildKey(String x, [VoidCallback? h]) => ElevatedButton(
      ...
      child: Center(child: Text(x, style: const TextStyle(fontSize: 24))));
  ...
  Widget build(BuildContext context) => GridView.count(
        ...
        children: [
          for (int i = 1; i <= 9; i++) buildKey(i.toString()),
          buildKey(
              "<-",
              () => setState(() {

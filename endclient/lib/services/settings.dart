...
class SettingsService {
  ...
  static SettingsService createSync() => SettingsService._().._load();
...
class Settings extends IJSON {
  ...
  Settings clone() => Settings(_service, serverURI, darkTheme, largeUI,
      showAdmin, sendNotifs, autoYield, useP2P, useWakeLock);
  ...
  factory Settings.fromJson(JSON json, SettingsService service) => Settings(
        service,

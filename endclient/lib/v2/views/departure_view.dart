...
import 'package:esys_client/v2/views/generic_gate_view.dart';
...
class _DepartureViewState extends State<DepartureView> {
  ...
  @override
  Widget build(BuildContext context) => GenericGateView(
